...
public class StreamPractice {
    ...
    public static <E> Map<E, Integer> frequencyTableStream(Collection<E> coll) {
        ...
        Map<E, Integer> result = new HashMap<>();
        return coll.stream().
                collect(Collectors.toMap(e -> e, unused -> 1, Integer::sum));
    }
    ...
    public static Stream<BigInteger> fibonacciNumbers() {
        ...
        // TODO: Implement me!
        return Stream.generate(() -> {
            BigInteger result = fibs[0].add(fibs[1]);
            fibs[0] = fibs[1];
            fibs[1] = result;
            return result;
        });
    ...
    public static BigInteger firstFibStartingFrom(BigInteger n) {
        ...
        return fibonacciNumbers().
                filter((BigInteger i) -> i.compareTo(n) >= 0).
                findFirst().
                get();
    }
    ...
    public static BigInteger nthFib(int n) {
        ...
        return fibonacciNumbers().skip(n - 2).findFirst().get();
    }
}
